...
let EventExplorer = class EventExplorer {
    ...
    lookupListeners(instance, key) {
        ...
        const hasEventMeta = Reflect.hasMetadata(constants_1.SquareboatNestEventConstants.eventName, instance, key);
        if (!hasEventMeta)
            return;
        const eventName = Reflect.getMetadata(constants_1.SquareboatNestEventConstants.eventName, instance, key);
